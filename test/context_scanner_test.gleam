...
import intent/context_scanner.{
  CodebaseContext, Gleam, Go, JavaScript, NoFramework, NoLanguage, Phoenix,
  Python, Rebar3, Rust, TypeScript, context_to_json, detect_framework_from_deps,
  detect_from_directory, detect_language_from_manifest, format_context,
}
