...
pub fn parse_handoff_lines_reconstructs_handoff_test() {
  let session = test_session("sess1", [], [], 1)
  let original_handoff = create_handoff(
    session,
    "test",
    "q1",
    "2026-01-18T10:30:00Z",
...
pub fn parse_handoff_lines_handles_multiple_handoffs_test() {
  ...
  let handoff1 = create_handoff(session1, "test1", "q1", "2026-01-18T10:00:00Z", "{}")
  let handoff2 = create_handoff(session2, "test2", "q2", "2026-01-18T10:30:00Z", "{}")

  let lines = [
    handoff_to_jsonl_line(handoff1),
    handoff_to_jsonl_line(handoff2),
  ]
...
pub fn handoff_includes_session_for_restoration_test() {
  ...
  let session_jsonl = "{\"id\":\"sess1\",\"answers\":[{\"question_id\":\"q1\"}]}"
