...
import intent/types.{type AntiPattern, type Behavior, AntiPattern, Behavior, Delete, Get, Patch, Post, Put}
import test_helpers
...
pub fn inversion_few_anti_patterns_test() {
  ...
  let spec_with_anti_patterns = types.Spec(
    ..spec,
    anti_patterns: [
      AntiPattern(
...
pub fn inversion_error_ratio_exact_threshold_test() {
  ...
  let success4 =
    test_helpers.make_test_behavior_with_status("get-tag", 200, [])
