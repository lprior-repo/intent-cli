...
pub fn spec_to_compact_with_captures_test() {
  ...
  let spec = test_helpers.make_test_spec_from_behaviors([behavior_with_captures])
...
pub fn format_compact_features_test() {
  ...
  let feature = test_helpers.make_test_feature("User Management", [
...
pub fn spec_to_compact_multiple_features_test() {
  ...
  let feature1 = test_helpers.make_test_feature("Auth", [
    test_helpers.make_test_behavior("login", []),
  ])
  let feature2 = test_helpers.make_test_feature("Users", [
    test_helpers.make_test_behavior("get-user", []),
  ])
