...
import intent/plan_mode.{
  ...
  type PlanBead, Blocked, CyclicDependency, Effort10min, Effort15min,
  Effort20min, Effort30min, Effort5min, ExecutionPhase, ExecutionPlan, Failed,
  MissingDependency, Pending, PlanBead, SessionNotFound,
}
