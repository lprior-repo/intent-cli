...
-spec decode_bits(
    bitstring(),
    fun((gleam@dynamic:dynamic_()) -> {ok, GHS} |
        {error, list(gleam@dynamic:decode_error())})
) -> {ok, GHS} | {error, decode_error()}.
...
-spec nullable(gleam@option:option(GHY), fun((GHY) -> json())) -> json().
...
-spec array(list(GIC), fun((GIC) -> json())) -> json().
