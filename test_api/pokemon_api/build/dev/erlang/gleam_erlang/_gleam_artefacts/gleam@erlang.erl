...
-file("src/gleam/erlang.gleam", 17).
?DOC(
...
-file("src/gleam/erlang.gleam", 27).
?DOC(
...
-file("src/gleam/erlang.gleam", 80).
?DOC(
...
-file("src/gleam/erlang.gleam", 93).
?DOC(
...
-file("src/gleam/erlang.gleam", 99).
?DOC(
...
-file("src/gleam/erlang.gleam", 109).
?DOC(
...
-spec rescue(fun(() -> FPA)) -> {ok, FPA} | {error, crash()}.
rescue(A) ->
    gleam_erlang_ffi:rescue(A).

-file("src/gleam/erlang.gleam", 41).
?DOC(
...
-file("src/gleam/erlang.gleam", 56).
?DOC(
...
-file("src/gleam/erlang.gleam", 124).
?DOC(
...
-file("src/gleam/erlang.gleam", 147).
?DOC(
...
-file("src/gleam/erlang.gleam", 208).
?DOC(
...
-file("src/gleam/erlang.gleam", 219).
?DOC(
...
-file("src/gleam/erlang.gleam", 223).
