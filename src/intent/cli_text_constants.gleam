...
/// KIRK: Analyze spec quality across coverage, clarity, testability, ai_readiness
pub const cmd_quality_desc = "KIRK: Analyze spec quality across coverage, clarity, testability, AI-readiness"
...
pub const kirk_quality_extended_help = "KIRK: Analyze spec quality across coverage, clarity, testability, AI-readiness
...
WHAT IT DOES
  ...
  requirements into structured Intent spec behaviors. Recognizes 4 pattern types:
  Ubiquitous (THE SYSTEM SHALL), Event-driven (WHEN...THEN), Conditional (IF...THEN),
  and State-based (IN state...THEN). Generates complete executable spec from
  requirements document with all behaviors and checks.
