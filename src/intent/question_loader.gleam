...
pub type CustomQuestions {
  CustomQuestions(
    ...
    shape: Option(CustomProfileQuestions),
...
fn parse_custom_database(
  ...
  let decoder =
    dynamic.decode9(
      ...
      dynamic.optional_field("shape", parse_custom_profile_questions),
...
fn merge_custom_questions(
  ...
  QuestionsDatabase(
    ...
    shape: merge_profile(db.shape, custom.shape),
...
fn parse_database(data: Dynamic) -> Result(QuestionsDatabase, QuestionLoadError) {
  let decoder =
    dynamic.decode9(
      ...
      dynamic.field("shape", parse_profile_questions),
...
pub fn get_questions(
  ...
  case profile, round {
    ...
    "shape", 1 -> db.shape.round_1
    "shape", 2 -> db.shape.round_2
