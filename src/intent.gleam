...
fn review_requirements_command() -> glint.Command(Nil) {
  ...
  |> glint.description("Review EARS requirements with validation questions")
  |> glint.flag(
    "checkpoint",
    flag.bool()
      |> flag.default(False)
...
fn review_contracts_command() -> glint.Command(Nil) {
  ...
  |> glint.description("Review KIRK contracts with validation questions")
  |> glint.flag(
    "checkpoint",
    flag.bool()
      |> flag.default(False)
...
fn review_structure_command() -> glint.Command(Nil) {
  ...
  |> glint.description("Review project structure with validation questions")
  |> glint.flag(
    "project",
    flag.string()
      |> flag.default("Project")
...
fn review_beads_command() -> glint.Command(Nil) {
  ...
  |> glint.description("Review generated beads (guidance command)")
}
