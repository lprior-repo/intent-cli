              ...
              True -> {
                let json_obj =
                  json.object([
                    ...
                    #(
                      "errors",
                      json.array([loader.format_error(e)], json.string),
                    ),
                  ])
                io.println(json.to_string(json_obj))
              }
          ...
          True -> {
            let json_obj =
              json.object([
                ...
                #(
                  "errors",
                  json.array(["spec file path required"], json.string),
                ),
              ])
            io.println(json.to_string(json_obj))
          }
            ...
            case lint_result {
              spec_linter.LintValid -> {
                case is_json {
                  True ->
                    io.println(
                      json.to_string(spec_linter.result_to_json(lint_result)),
                    )
                  False ->
                    io.println(
              ...
              spec_linter.LintWarnings(warnings) -> {
                case is_json {
                  ...
                  False -> io.println(spec_linter.format_warnings(warnings))
                }
                halt(exit_fail)
              }
            }
