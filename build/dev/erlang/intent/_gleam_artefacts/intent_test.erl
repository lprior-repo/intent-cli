...
rules_engine_check_when_status_equals_test() ->
    Rule = {rule,
        ...
        {some,
            {'when', <<"== 200"/utf8>>, {some, get}, {some, <<"/users"/utf8>>}}},
...
rules_engine_check_when_status_greater_than_test() ->
    Rule = {rule,
        ...
        {some,
            {'when', <<"> 399"/utf8>>, {some, post}, {some, <<"/create"/utf8>>}}},
        {rule_check, [], [], [], [], <<""/utf8>>, <<""/utf8>>},
        gleam@json:null()},
...
rules_engine_check_when_status_less_than_test() ->
    Rule = {rule,
        ...
        {some,
            {'when', <<"< 300"/utf8>>, {some, get}, {some, <<"/data"/utf8>>}}},
        {rule_check, [], [], [], [], <<""/utf8>>, <<""/utf8>>},
        gleam@json:null()},
    Response = make_execution_result(
        201,
...
rules_engine_check_body_must_contain_test() ->
    Rule = {rule,
        ...
        {some,
            {'when', <<"== 200"/utf8>>, {some, get}, {some, <<"/test"/utf8>>}}},
...
rules_engine_nested_null_field_test() ->
    Rule = {rule,
        ...
        {some,
            {'when', <<"== 200"/utf8>>, {some, get}, {some, <<"/nested"/utf8>>}}},
...
rules_engine_empty_object_test() ->
    Rule = {rule,
        ...
        {some,
            {'when', <<"== 200"/utf8>>, {some, get}, {some, <<"/data"/utf8>>}}},
...
rules_engine_emoji_in_description_test() ->
    Rule = {rule,
        ...
        {some,
            {'when', <<"== 200"/utf8>>, {some, get}, {some, <<"/status"/utf8>>}}},
        {rule_check, [], [], [], [], <<""/utf8>>, <<""/utf8>>},
        gleam@json:null()},
    Response = {execution_result,
        200,
